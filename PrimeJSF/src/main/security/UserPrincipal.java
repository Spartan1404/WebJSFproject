package com.example.primejsf.security;
...
public class UserPrincipal implements UserDetails {
    ...
    public static UserPrincipal create(AutenUserDTO user) {
    ...
    public static UserPrincipal create(AutenUserDTO user, Map<String, Object> attributes) {
